      ...
      <footer>
        ...
        <div className="socialLinks">
          <Anchor href="http://discord.gg/npeDKJh" target>
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-discord spin" viewBox="0 0 16 16">
          ...
          <Anchor href="https://www.facebook.com/invisiblewallsstudio" target>
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-facebook spin" viewBox="0 0 16 16">
          ...
          <Anchor href="https://www.youtube.com/channel/UCAqeOUBMp_aX3tVZm1i_njQ" target>
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-youtube spin" viewBox="0 0 16 16">
          ...
          <Anchor href="https://twitter.com/invisible0walls" target>
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-twitter spin" viewBox="0 0 16 16">
          ...
          <Anchor href="https://www.instagram.com/invisible_walls/" target>
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-instagram spin" viewBox="0 0 16 16">
